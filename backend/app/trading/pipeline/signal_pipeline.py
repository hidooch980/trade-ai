...
class SignalPipeline:
    ...
    def __init__(self):
        ...
        self.smart_money_fusion = SmartMoneyFusion()
    ...
    async def generate(
        ...
        candles = [
            ...
            {"open":2390,"high":2400,"low":2380,"close":2398},

            {"open":2405,"high":2420,"low":2400,"close":2418},

            {"open":2425,"high":2450,"low":2410,"close":2445}
        ...
        smart_money = self.smart_money_fusion.analyze(
            candles,
            structure,
            liquidity,
            order_block,
