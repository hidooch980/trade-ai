...
class IndicatorBridge:
    ...
    def analyze(self, candles):
        ...
        return {
            ...
            "score": (
                (20 if ema.get("signal") == "BULLISH" else
                 -20 if ema.get("signal") == "BEARISH" else 0)
                +
                (15 if macd.get("signal") == "BULLISH" else
                 -15 if macd.get("signal") == "BEARISH" else 0)
            )
        }
